...
```bash
# สแกน /home ทั้งหมด (default)
bash <(curl -s https://raw.githubusercontent.com/ufavision/cronjob-disable/main/check-disable-wordpress)


```
# หรือระบุ path เอง
bash <(curl -s https://raw.githubusercontent.com/ufavision/cronjob-disable/main/check-disable-wordpress) /home/jan2026newkey
### ตัวอย่างผลที่ได้
...
```bash
# สแกนและแก้ไขทุก /home, /home2, /home3 ... อัตโนมัติ
bash <(curl -s https://raw.githubusercontent.com/ufavision/cronjob-disable/main/edit-disable-wordpress)

# หรือระบุ path เอง
bash <(curl -s https://raw.githubusercontent.com/ufavision/cronjob-disable/main/edit-disable-wordpress) /home/jan2026newkey
```
